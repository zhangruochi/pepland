...
if __name__ == "__main__":
    ...
    # # test scaffold_split
    # dataset = MoleculeDataset('dataset/pep_atlas_uniparc_smiles_30', dataset='tox21')
    # smiles_list = pd.read_csv('dataset/pep_atlas_uniparc_smiles_30/processed/smiles.csv', header=None)[0].tolist()
    ...
    dataset = MoleculeDataset('dataset/pep_atlas_uniparc_smiles_30', dataset='pep_atlas_uniparc_smiles_30')
    ...
    dataset = MoleculeDataset('dataset/pep_atlas_uniparc_smiles_30', dataset='pep_atlas_uniparc_smiles_30')
    smiles_list = pd.read_csv('dataset/pep_atlas_uniparc_smiles_30/processed/smiles.csv', header=None)[
        0].tolist()
    train_dataset, valid_dataset, test_dataset, (train_smiles, valid_smiles,
                                                 test_smiles) = \
